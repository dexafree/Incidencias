...
public class MainActivity extends SherlockActivity {
    ...
    public boolean provsEsp(){
        ...
        if (settings.getBoolean("A CORU�A", true)){
            return true;
        }
    ...
    public void actualizar() {
        ...
        if((pm.getBoolean("VI", true) == false && pm.getBoolean("BI", true) == false && pm.getBoolean("SS", true) == false ) && provsEsp() == false){
            MyCard aviso = new MyCard("No tienes ninguna provincia seleccionada!", "En el Men�, accede al apartado provincias y selecciona de qu� provincias quieres conocer el estado del tr�fico");
            ...
            card.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if(GooglePlayServicesUtil.isGooglePlayServicesAvailable(MainActivity.this) == ConnectionResult.SUCCESS){
                        ...
                        Toast.makeText(MainActivity.this, "Asegúrese de que su dispositivo tiene instalado y actualizado el servicio Google Play Services", Toast.LENGTH_SHORT).show();
                    }
